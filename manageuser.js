...
function setotpassword(){
    otpassword = $("#otpassword").val();
    var valid=passwordRegEx.exec(otpassword);
    //if (!valid){
...
function userlogin(){
    ...
    $.ajax({
        ...
        data: JSON.stringify({phoneNumber:phonenumber, oneTimePassword:otpassword}),
